<template>
  <div class="playlist-modal">
    ...
    <!-- createPlaylistModal -->
    <div class="playlists" v-if="createPlaylistModal">
    ...
    <span class="line2" v-if="createPlaylistModal"></span>
    ...
    <!-- addPlaylistModal -->
    <div class="playlists" v-if="addPlaylistModal">
